...
using ResolutionSwitcher.Desktop.UI;
using ResolutionSwitcher.Infrastructure.Configuration;
using ResolutionSwitcher.Infrastructure.Display;
using ResolutionSwitcher.Infrastructure.Processes;
using ResolutionSwitcher.Infrastructure.Startup;
